...
int jogo() {
    ...
    superPoder1 = (unsigned long int) populacao1 + (unsigned long int) area1 + (unsigned long int) pib1 + (unsigned long int) pibPerCapita1 + (unsigned long int) pontosTuristicos1;
    ...
    printf("Número de Super Poder: %d\n", superPoder1);
    ...
    superPoder2 = (unsigned long int) populacao2 + (unsigned long int) area2 + (unsigned long int) pib2 + (unsigned long int) pibPerCapita2 + (unsigned long int) pontosTuristicos2;
